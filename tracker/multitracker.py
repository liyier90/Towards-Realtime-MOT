...
class JDETracker:
    def __init__(self, config, frame_rate=30):
        ...
        # _create_jde_model
        self.model = Darknet(config["cfg"], nID=14455)
        self.model.load_state_dict(
            torch.load(config["weights"], map_location="cpu")["model"], strict=False
        )
        ...
        self.frame_id = 0
        self.det_thresh = config["conf_thres"]
